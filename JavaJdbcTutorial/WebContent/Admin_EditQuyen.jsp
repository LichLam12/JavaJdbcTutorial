...
<body>
	...
	<div class="info">
		<div class="container marketing lead">
			...
			<form id="login_form_contentGr2" class="was-validated"
				action="EditQuyen?maquyen=${infoquyen.maQuyen }&username=${infoadmin.username }&password=${infoadmin.password }"
				 method="post" style="font-size: 19px">
				<div class="row">
					<div class="col">
						<h2 class="text-center per_info">THÔNG TIN QUYỀN</h2>
					</div>
					<div class="col">
						<div class="col-auto text-center operation">
							<button type="button" id="edit_on"
								class="btn btn-outline-success" style="width: 100px">Edit</button>
							<button type=submit class="btn btn-outline-primary"
								style="width: 100px" id="save_on" disabled>Save</button>
						</div>
					</div>
				</div>
				<hr>
				...
				<div class="row featurette">
					<div class="col-md-6">
						<div style="margin-bottom: 25px">
							<span class="red_right" id="contentGrID_error_message2"></span>
						</div>
						<div class="form-group row">
							<label for="inputEmail3" class="col-sm-3 col-form-label">Mã quyền:</label>
							<div class="col-sm-9">

								<input type="text" class="form-control" id="contentGrID2"
									name="maquyen" placeholder="Nhập vào họ và tên" disabled
									value="${infoquyen.maQuyen }">
							</div>
						</div>
					...
					<div class="col-md-6 ">
						<div style="margin-bottom: 25px">
							<span class="red_right" id="contentGrName_error_message2"></span>
						</div>
						<div class="form-group row">
							<label for="inputEmail3" class="col-sm-3 col-form-label">Tên quyền:</label>
							<div class="col-sm-9">

								<input type="text" class="form-control" id="contentGrName2"
									name="tenquyen" placeholder="Nhập vào họ và tên" disabled
									value="${infoquyen.tenQuyen }">
							</div>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
	 ...
	 document.getElementById("edit_on").onclick = function Edit_Click() {//nhận vào object là mybutton
         //if(document.getElementById("input_on").disabled=true){
             document.getElementById("contentGrName2").disabled=false;
     ...
     document.getElementById("save_on").onclick = function Save_Click() {//nhận vào object là save_on
		...
		check_contentGrName2();
         ...
         if(error_contentGrName2 == false){
             document.getElementById("contentGrName2").disabled=true;
