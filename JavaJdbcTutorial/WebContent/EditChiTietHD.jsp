...
<body>
	...
	<div class="info">
		<div class="container marketing lead">
			...
			<form id="login_form_editchitiethd" class="was-validated"
				action="EditChiTietHD?soChiTiet=${infochitiethd.soChiTiet }&username=${infoadmin.username }&password=${infoadmin.password }"
				 method="post" style="font-size: 19px">
				<div class="row">
					<div class="col">
						<h2 class="text-center per_info">THÔNG TIN CHI TIẾT HÓA ĐƠN</h2>
					</div>
					<div class="col">
				...
				<div class="row featurette">
					<div class="col-md-6">
						...
						<div class="form-group row">
							<label for="inputEmail3" class="col-sm-3 col-form-label">Số chi tiết:</label>
							<div class="col-sm-9">

								<input type="text" class="form-control" id=""
									name="soChiTiet" placeholder="Nhập vào họ và tên" disabled
									value="${infochitiethd.soChiTiet }">
							</div>
						</div>
						...
						<div class="form-group row">
							<label for="inputPassword3" class="col-sm-3 col-form-label">Số hóa đơn:</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="soHD"
									name="soHD" placeholder="Nhập vào mã khách hàng" disabled
									value="${infochitiethd.soHD }">
							</div>
						</div>
						
						<div class="top_perinfo">
							<span class="red_right" id="soHD_error_message2"></span>
						</div>
						<div class="form-group row">
							<label for="inputPassword3" class="col-sm-3 col-form-label">Mã mỹ phẩm:</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="soHD2"
									name="maMyPham" placeholder="Nhập vào mã khách hàng" disabled
									value="${infochitiethd.maMyPham }">
							</div>
						</div>
					...
					<div class="col-md-6" style="margin-top: -17px;">
						<div class="top_perinfo">
							<span class="red_right" id="soLuong_error_message"></span>
						</div>
						<div class="form-group row">
							<label for="inputPassword3" class="col-sm-3 col-form-label">Số lượng:</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="soLuong"
									name="soLuong" placeholder="Nhập vào mã khách hàng" disabled
									value="${infochitiethd.soLuong }">
							</div>
						</div>
						
						<div >
                            <c:if test="${infochitiethd.hoaDonDo==true }">
	                            <label for="text" class="lbl_tinhtranghd" style="margin-top: 20px;">Hóa đơn đỏ:</label>
	                            <select id="hoaDonDo" name="hoaDonDo" class="custom-select d-block my-3 select_tinhtranghd" required disabled style="width: 73%;float: right;">
	                                        <option value="1">Không xuất hóa đơn đỏ</option>
	                                        <option value="2" selected>Xuất hóa đơn đỏ</option>
	                            </select>
                            </c:if>
                            <c:if test="${infochitiethd.hoaDonDo==false }">
                                <label for="text" class="lbl_tinhtranghd" style="margin-top: 20px;">Hóa đơn đỏ:</label>
	                            <select id="hoaDonDo" name="hoaDonDo" class="custom-select d-block my-3 select_tinhtranghd" required disabled style="width: 73%;float: right;">
	                                        <option value="1">Không xuất hóa đơn đỏ</option>
	                                        <option value="2">Xuất hóa đơn đỏ</option>
	                            </select>
                            </c:if>
                        </div>    
	...
	<script type="text/javascript">
	 ...
	 document.getElementById("edit_on_3").onclick = function Edit3_Click() {//nhận vào object là mybutton
         //if(document.getElementById("input_on").disabled=true){
             ...
             document.getElementById("soHD").disabled=false;
             document.getElementById("soHD2").disabled=false;
            document.getElementById("soLuong").disabled=false;
            document.getElementById("hoaDonDo").disabled=false;
     ...
     document.getElementById("save_on_3").onclick = function Save3_Click() {//nhận vào object là save_on
		...
		if(error_soHD == false && error_soHD2 == false && error_soluong == false) {
             ...
             document.getElementById("soHD").disabled=true;
             document.getElementById("soHD2").disabled=true;
            document.getElementById("soLuong").disabled=true;
            document.getElementById("hoaDonDo").disabled=true;
