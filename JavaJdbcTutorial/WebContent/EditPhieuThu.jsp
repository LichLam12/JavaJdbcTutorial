...
<body>
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="dropdown03">
					<a class="dropdown-item"
						href="DisplayHoaDon?username=${infoadmin.username }&password=${infoadmin.password }">HÓA ĐƠN
						</a>
				    <a class="dropdown-item"
	...
	<div class="info">
		<div class="container marketing lead">
			...
			<form id="login_form_editphieuthu" class="was-validated"
				action="EditPhieuThu?maPhieuThu=${infophieuthu.maPhieuThu }&username=${infoadmin.username }&password=${infoadmin.password }"
				 method="post" style="font-size: 19px">
				<div class="row">
					<div class="col">
						<h2 class="text-center per_info">THÔNG TIN PHIẾU THU</h2>
					</div>
					<div class="col">
				...
				<div class="row featurette">
					<div class="col-md-6">
						...
						<div class="form-group row">
							<label for="inputEmail3" class="col-sm-3 col-form-label">Mã phiếu thu:</label>
							<div class="col-sm-9">

								<input type="text" class="form-control" id=""
									name="maphieuthu" placeholder="Nhập vào họ và tên" disabled
									value="${infophieuthu.maPhieuThu }">
							</div>
						</div>
						...
						<div class="form-group row">
							<label for="inputEmail3" class="col-sm-3 col-form-label">Ngày
								xuất Phiếu:</label>
							<div class="col-sm-9">
								<input type="date" id="ngayXuatHD" name="ngayXuatPhieu" class="form-control"
									disabled required value="${infophieuthu.ngayXuatPhieu }">
							</div>
						</div>
						...
						<div class="form-group row">
							<label for="inputEmail3" class="col-sm-3 col-form-label">Người nộp:</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="fullname"
									name="nguoiNop" placeholder="Nhập vào Username" disabled
									value="${infophieuthu.nguoiNop }">
							</div>
						</div>
					...
					<div class="col-md-6" style="margin-top: -17px;">
						...
						<div class="form-group row">
							<label for="inputPassword3" class="col-sm-3 col-form-label">Số tiền:</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="triGiaHD"
									name="soTien" placeholder="Nhập vào mã khách hàng" disabled
									value="${infophieuthu.soTien }">
							</div>
						</div>
	...
	<script type="text/javascript">
     ...
     document.getElementById("save_on_3").onclick = function Save3_Click() {//nhận vào object là save_on
        ...
        check_soHD();
         ...
         if(error_triGiaHD == false && error_fullname == false && error_soHD == false){
