...
<body>
    ...
    <div class="md-modal5 md-effect-7" id="modal-3options">
        <div class="md-content">
            ...
            <form id="login_form_addchitiethd" class="was-validated"
                action="InsertChiTietHD?username=${infoadmin.username }&password=${infoadmin.password }" 
                method="post">
                <fieldset>
                        <div>
                        ...
                        <div>
                            <input type="text" id="soHD" name="soHD" placeholder="Nhập vào số hóa đơn">
                        </div>
                                     
                        <div>
                            <label for="text">Mã mỹ phẩm</label>
                            <span class="red_right_add2e" id="mamypham_error_message"></span>
                            <!-- cột hiện lỗi validate -->
                        </div>   
                        <div>
                            <input type="text" id="mamypham" name="maMyPham" placeholder="Nhập mã mỹ phẩm">
                        </div>
                        
                        <div>
                            <label for="text">Số lượng</label>
                            <span class="red_right_add2e" id="soluong_error_message"></span>
                            <!-- cột hiện lỗi validate -->
                        </div>
                        <div>
                            <input type="text" id="soluong" name="soLuong" placeholder="Nhập số lượng mỹ phẩm">
                        </div>
                        
                        <div>
                            <label for="text" class="lbl_tinhtranghd" style="margin:3px 18px 0px 0px;">Hóa đơn đỏ</label>
                            <select name="hoaDonDo" class="custom-select d-block my-3 select_tinhtranghd" style="width: 70%;" required>
    ...
    <div class="md-modal5 md-effect-7" id="modal-4options">
        <div class="md-content">
            ...
            <form id="login_form_repairchitiethd" class="was-validated" action="" method="post">
                <fieldset>
                       <div>
                            <label for="text">Số chi tiết</label>
                            <span class="red_right_add2e" id=""></span>
                            <!-- cột hiện lỗi validate -->
                        </div>
                        <div>
                        ...
                        <div>
                            <label for="text">Số hóa đơn</label>
                            <span class="red_right_add2e" id="soHD_error_message2"></span>
                            <!-- cột hiện lỗi validate -->
                        </div>
                        <div>
                            <input type="text" id="soHD2" placeholder="Nhập vào số hóa đơn">
                        </div>
                                     
                        <div>
                            <label for="text">Mã mỹ phẩm</label>
                            <span class="red_right_add2e" id="mamypham_error_message2"></span>
                            <!-- cột hiện lỗi validate -->
                        </div>   
                        <div>
                            <input type="text" id="mamypham2" placeholder="Nhập mã mỹ phẩm">
                        </div>
                        
                        <div>
                            <label for="text">Số lượng</label>
                            <span class="red_right_add2e" id="soluong_error_message2"></span>
                            <!-- cột hiện lỗi validate -->
                        </div>
                        <div>
                            <input type="text" id="soluong2" placeholder="Nhập số lượng mỹ phẩm">
                        </div>
                        
                        <div>
                            <label for="text" class="lbl_tinhtranghd" style="margin:3px 18px 0px 0px;">Hóa đơn đỏ</label>
                            <select class="custom-select d-block my-3 select_tinhtranghd" style="width: 70%;" required>
                                        <option value="">Chọn lựa</option>
                                        <option value="1">True</option>
                                        <option value="2">False</option>
                            </select>
    ...
    <div id="cg" class="info">
        <div class="container marketing lead">
            <div class="row">
                <div class="col">
                    <h2 class="text-left per_info">QUẢN LÝ DANH SÁCH CHI TIẾT HÓA ĐƠN</h2>
                </div>
                <div class="col">
                    ...
                    <div class="cont_select_center">
                        <div class="select_mate" data-mate-select="active">
                            <select name="" onclick="return false;" id="">
                                ...
                                <option value="2">Số hóa đơn</option>
                                <option value="3">Mã mỹ phẩm</option>
                            </select>
            ...
            <table id="class-info" class="table table-hover text-center">
                ...
                <tbody>
                    <c:forEach var="list" items="${qlchitiethd }" >
                    <tr>
                        <td>${list.soChiTiet }</td>
                        <td>${list.soHD }</td>
                        <td>${list.maMyPham }</td>
                        <td>${list.soLuong }</td>
                        <td>${list.hoaDonDo }</td>
                        <td><a href="Display_EditChiTietHD?soChiTiet=${list.soChiTiet}&username=${infoadmin.username }&password=${infoadmin.password }">
							<i class="material-icons button edit md-trigger">edit</i> </a>
							<a href="DeleteChiTietHD?soChiTiet=${list.soChiTiet}&username=${infoadmin.username }&password=${infoadmin.password }">
            ...
            <nav aria-label="Page navigation example">
                ...
                <!-- numberpage trong HomeController -->
					<c:if test="${numberpage==1}">
	                    ...
	                    <li class="page-item"><a class="page-link" href="DisplayChiTietHD?pageid=1&username=${infoadmin.username }&password=${infoadmin.password }">1</a></li>
	                    <li class="page-item"><a class="page-link" href="DisplayChiTietHD?pageid=2&username=${infoadmin.username }&password=${infoadmin.password }">2</a></li>
	                    <li class="page-item"><a class="page-link" href="DisplayChiTietHD?pageid=3&username=${infoadmin.username }&password=${infoadmin.password }">3</a></li>
	                   	<li class="page-item"><a class="page-link" href="DisplayChiTietHD?pageid=4&username=${infoadmin.username }&password=${infoadmin.password }">4</a></li>
	                   	<li class="page-item"><a class="page-link" href="DisplayChiTietHD?pageid=5&username=${infoadmin.username }&password=${infoadmin.password }">5</a></li>
	                    <li class="page-item">
	                        <a class="page-link" href="DisplayChiTietHD?pageid=${numberpage+1}&username=${infoadmin.username }&password=${infoadmin.password }">Sau</a>
	                    </li>
                    </c:if>
                    
                    <c:if test="${numberpage==maxpageid}">
						<li class="page-item">
	                        <a class="page-link" href="DisplayChiTietHD?pageid=${numberpage-1}&username=${infoadmin.username }&password=${infoadmin.password }" tabindex="-1">Trước</a>
	                    </li>
	                    <li class="page-item"><a class="page-link" href="DisplayChiTietHD?pageid=1&username=${infoadmin.username }&password=${infoadmin.password }">1</a></li>
	                    <li class="page-item"><a class="page-link" href="DisplayChiTietHD?pageid=2&username=${infoadmin.username }&password=${infoadmin.password }">2</a></li>
	                    <li class="page-item"><a class="page-link" href="DisplayChiTietHD?pageid=3&username=${infoadmin.username }&password=${infoadmin.password }">3</a></li>
