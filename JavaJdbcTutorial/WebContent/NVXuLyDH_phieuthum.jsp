...
<body>
    ...
    <div class="md-modal5 md-effect-7" id="modal-3options">
        <div class="md-content">
            ...
            <form id="login_form_addphieuthu" class="was-validated" 
            action="InsertPhieuThu?username=${infoadmin.username }&password=${infoadmin.password }" 
            method="post">
                <fieldset>
                        <div>
                                <label for="time" class="lbl_time">Ngày xuất phiếu</label> 
                                <input type="date" id="doB" name="ngayXuatPhieu" class="input_time" style="width: 57%;" required />
                        </div>    
                        ...
                        <div>
                            <input type="text" id="triGiaHD" name="soTien" placeholder="Nhập số tiền phiếu thu">
                        </div>
                        
                        <div>
                            <label for="text">Người nộp</label>
                            <span class="red_right_add2e" id="fullname_error_message"></span>
                            <!-- cột hiện lỗi validate -->
                        </div>
                        <div>
                            <input type="text" id="fullname" name="nguoiNop" placeholder="Nhập tên người nhận phiếu">
                        </div>
    ...
    <div class="md-modal5 md-effect-7" id="modal-4options">
        <div class="md-content">
            ...
            <form id="login_form_repairphieuthu" class="was-validated" action="" method="post">
                <fieldset>
                       <div>
                            <label for="text">Mã phiếu thu</label>
                        ...
                        <div>
                                <label for="time" class="lbl_time">Ngày xuất phiếu</label> 
                                <input type="date" id="doB" class="input_time" style="width: 57%;" required />
                        </div>    
                        ...
                        <div>
                            <input type="text" id="triGiaHD2" placeholder="Nhập số tiền phiếu thu">
                        </div>
                        
                        <div>
                            <label for="text">Người nộp</label>
                            <span class="red_right_add2e" id="fullname_error_message2"></span>
                            <!-- cột hiện lỗi validate -->
                        </div>
                        <div>
                            <input type="text" id="fullname2" placeholder="Nhập tên người nhận phiếu">
                        </div>
    ...
    <div id="cg" class="info">
        <div class="container marketing lead">
            <div class="row">
                <div class="col">
                    <h2 class="text-left per_info">QUẢN LÝ DANH SÁCH PHIẾU THU</h2>
                </div>
                <div class="col">
                    ...
                    <div class="cont_select_center">
                        <div class="select_mate" data-mate-select="active">
                            <select name="" onclick="return false;" id="">
                                ...
                                <option value="1">Mã phiếu thu</option>
                                <option value="2">Ngày xuất phiếu</option>
                                <option value="3">Số hóa đơn</option>
                            </select>
            ...
            <table id="class-info" class="table table-hover text-center">
                ...
                <tbody>
                <c:forEach var="list" items="${qlphieuthu }" >
                    <tr>
                        <td>${list.maPhieuThu }</td>
                        <td>${list.ngayXuatPhieu }</td>
                        <td>${list.soTien }</td>
                        <td>${list.nguoiNop }</td>
                        <td>${list.soHD }</td>
                        <td><a href="Display_EditPhieuThu?maPhieuThu=${list.maPhieuThu}&username=${infoadmin.username }&password=${infoadmin.password }">
							<i class="material-icons button edit md-trigger">edit</i> </a>
							<a href="DeletePhieuThu?maPhieuThu=${list.maPhieuThu}&username=${infoadmin.username }&password=${infoadmin.password }">
            ...
            <nav aria-label="Page navigation example">
                ...
                <!-- numberpage trong HomeController -->
					<c:if test="${numberpage==1}">
	                    ...
	                    <li class="page-item"><a class="page-link" href="DisplayPhieuThu?pageid=1&username=${infoadmin.username }&password=${infoadmin.password }">1</a></li>
	                    <li class="page-item"><a class="page-link" href="DisplayPhieuThu?pageid=2&username=${infoadmin.username }&password=${infoadmin.password }">2</a></li>
	                    <li class="page-item"><a class="page-link" href="DisplayPhieuThu?pageid=3&username=${infoadmin.username }&password=${infoadmin.password }">3</a></li>
	                    <li class="page-item">
	                        <a class="page-link" href="DisplayPhieuThu?pageid=${numberpage+1}&username=${infoadmin.username }&password=${infoadmin.password }">Sau</a>
	                    </li>
                    </c:if>
                    
                    <c:if test="${numberpage==maxpageid}">
						<li class="page-item">
	                        <a class="page-link" href="DisplayPhieuThu?pageid=${numberpage-1}&username=${infoadmin.username }&password=${infoadmin.password }" tabindex="-1">Trước</a>
	                    </li>
	                    <li class="page-item"><a class="page-link" href="DisplayPhieuThu?pageid=1&username=${infoadmin.username }&password=${infoadmin.password }">1</a></li>
	                    <li class="page-item"><a class="page-link" href="DisplayPhieuThu?pageid=2&username=${infoadmin.username }&password=${infoadmin.password }">2</a></li>
	                    <li class="page-item"><a class="page-link" href="DisplayPhieuThu?pageid=3&username=${infoadmin.username }&password=${infoadmin.password }">3</a></li>
