...
<body>
	...
	<div class="info">
		<div class="container marketing lead">
			...
			<form id="login_form_agent" class="was-validated"
				action="EditAdmin?manv=${infoadmin.maNV }&maquyen=${infoadmin.maQuyen }&username=${infoadmin.username }&password=${infoadmin.password }"
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="username"
									name="username" placeholder="Nhập vào Username" disabled
									value="${infoadmin.username }">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="password" class="form-control" id="password"
									name="password" placeholder="Nhập vào password" disabled
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="date" id="doB" name="ngaysinh" class="form-control"
									disabled required value="${infoadmin.ngaySinh }">
							</div>
						</div>
