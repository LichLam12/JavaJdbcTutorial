...
<body>
	...
	<!-- form login -->
                        ...
                        <div class="cart_box" style="border-bottom: 1px solid #afa7a7;padding: 10px;height: 120px;">
                            <div class="message">
                                ...
                                <div class="list_desc">
                                        ...
                                        <a href="SaveIntoCart?page=3&command=remove&mamypham=<%=list.getValue().getProduct().getMaMyPham()%>"><span style="font-size:19px;" aria-hidden="true">
        ...
        <script type="text/javascript">
            //nút close của login
                document.getElementById("closebtn").onclick = function abcxmp() {
                        $("#modal-20").hide();
                    };
                document.getElementById("btn_left3").onclick = function abcxmp2() { //nhấn vào nút đăng nhập trên thanh menu
                        $("#modal-20").show();
                    };
           ...
           <div class="col-md-5">
            ...
            <div class="col-md-7">
                ...
                <div class="into_giohang">
                	<a href="SaveIntoCart?page=3&command=plus&mamypham=${mypham.maMyPham }">
