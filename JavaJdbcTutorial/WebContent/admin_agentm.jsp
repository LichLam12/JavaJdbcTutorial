...
<body>
   ...
   <!-- Form add student -->
    <div class="md-modal md-effect-7" id="modal-agent">
        <div class="md-content">
            ...
            <form id="login_form_agent" class="was-validated pre-scrollable2" 
            action="InsertNhanVien?username=${infoadmin.username }&password=${infoadmin.password }" 
            method="post">
                <fieldset>
                    <div id="left_hiddenform">
                        ...
                        <div>
                            <input type="text" id="username" name="usernamenv" placeholder="Nhập vào username">
                        </div>
                        ...
                        <div>
                            <input type="text" id="password" name="passwordnv" placeholder="Nhập vào password">
                        </div>
                        ...
                        <div>
                            <input type="text" id="fullname" name="tennv" placeholder="Nhập vào họ và tên">
                        </div>
                        ...
                        <div>
                            <input type="text" id="luong" name="luong" placeholder="Nhập vào lương">
                        </div>
                    </div>
                    <!-- end left_hiddenform -->
                    ...
                    <c:if test="${infoadmin.gioiTinh==0}">
                        ...
                        <div>
                            <label for="text" class="lbl_authorityID">Mã quyền</label>
                            <select name="maquyen" class="custom-select d-block my-3 select_authorityID" required>
    ...
    <!-- Form repair student -->
    <div class="md-modal md-effect-7" id="modal-agent2">
        <div class="md-content">
            <h4>
                <span>
                        Sửa Nhân Viên
            ...
            <form id="login_form_agent2" class="was-validated pre-scrollable2" action="" method="post">
                <fieldset>
                    <div id="left_hiddenform">
                        <div>
                            <label for="text">Username</label>
                    ...
                    <div id="right_hiddenform">  
                        <div class="custom-controls-stacked d-block my-3">
                         ...
                         <div>
                            <label for="text" class="lbl_authorityID">Mã quyền</label>
                            <select class="custom-select d-block my-3 select_authorityID" required>
                                        <option value="">Chọn mã quyền</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
    ...
    <div id="ques" class="info">
        <div class="container marketing lead">
            <div class="row">
                <div class="col">
                    <h2 class="text-left per_info">QUẢN LÝ DANH SÁCH NHÂN VIÊN</h2>
                </div>
                <div class="col">
                 <div class="col-auto text-right btn-men operation">
                    <a class="md-trigger btn" data-modal="modal-agent" id="btn_left">
                    ...
                    <div class="cont_select_center">
                        <div class="select_mate" data-mate-select="active">
                            <select name="" onclick="return false;" id="">
                                ...
                                <option value="4">Mã quyền</option>
                            </select>
            ...
            <table id="class-info" class="table table-hover text-center">
                ...
                <tbody>
                	<c:forEach var="list" items="${qlnhanvien }" >
                    <tr>
                        <td>${list.maNV }</td>
                        <td>${list.username }</td>
                        <td>${list.password }</td>
                        ...
                        <td>${list.luong }</td>
                        <td>${list.maQuyen }</td>
                        <td><a href="Display_EditAgent?manv=${list.maNV}&username=${infoadmin.username }&password=${infoadmin.password }">
							<i class="material-icons button edit md-trigger">edit</i> </a>
							<a href="Admin_DeleteAgent?manv=${list.maNV}&usernamenv=${list.username }&username=${infoadmin.username }&password=${infoadmin.password }">
