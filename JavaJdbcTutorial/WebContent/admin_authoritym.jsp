   ...
   <!-- Form add Option, sử dụng chung với content group -->
    <div class="md-modal5 md-effect-7" id="modal-3options">
        <div class="md-content">
            ...
            <form id="login_form_contentGr" class="was-validated" action="InsertQuyen?username=${infoadmin.username }&password=${infoadmin.password }"
             method="post">
                <fieldset>
                <!--  
                        <div>
                            <label for="text">Mã Quyền</label>
                            <span class="red_right_add2e" id="contentGrID_error_message"></span>
                            <!-- cột hiện lỗi validate 
                        </div>
                        <div>
                            <input type="text" id="contentGrID" name="maquyen" placeholder="Nhập vào mã quyền">
                        </div>
                        -->
                        <div>
                            <label for="text">Tên Quyền</label>
                            <span class="red_right_add2e" id="contentGrName_error_message"></span>
                            <!-- cột hiện lỗi validate -->
                        </div>
                        <div>
                            <input type="text" id="contentGrName" name=tenquyen placeholder="Nhập vào tên quyền">
                        </div>
                </fieldset>
                <div>
                    <div id="btn">
        ...
        <div class="md-content">
            ...
            <form id="login_form_contentGr2" class="was-validated" action="" method="post">
                <fieldset>
                        ...
                        <div>
                            <input type="text" id="contentGrID2" placeholder="Nhập vào mã quyền" disabled>
                        </div>
                        <div>
                            <label for="text">Tên Quyền</label>
                        ...
                        <div>
                            <input type="text" id="contentGrName2" placeholder="Nhập vào tên quyền">
                        </div>
                </fieldset>
                <div>
                    <div id="btn">
    ...
    <div id="cg" class="info">
        <div class="container marketing lead">
            <div class="row">
                <div class="col">
                    <h2 class="text-left per_info">QUẢN LÝ DANH SÁCH QUYỀN</h2>
                </div>
                <div class="col">
                    ...
                    <div class="cont_select_center">
                        <div class="select_mate" data-mate-select="active">
                            <select name="" onclick="return false;" id="">
                                ...
                                <option value="1">Mã Quyền</option>
                                <option value="2">Tên Quyền</option>
                            </select>
            ...
            <table id="class-info" class="table table-hover text-center">
                ...
                <tbody>
                	<c:forEach var="list" items="${qlquyen }" >
                    <tr>
                        <td>${list.maQuyen}</td>
                        <td>${list.tenQuyen}</td>
                        <td><a href="DisplayEditQuyen?maquyen=${list.maQuyen}&username=${infoadmin.username }&password=${infoadmin.password }">
							<i class="material-icons button edit md-trigger">edit</i> </a>
							<a href="Admin_DeleteQuyen?maquyen=${list.maQuyen}&username=${infoadmin.username }&password=${infoadmin.password }">
							 <i class="material-icons button delete">delete</i></a>
						</td>
                    </tr>
                    </c:forEach>
                   
                            <!-- Thư viện hiệu ứng ẩn hiện form -->
