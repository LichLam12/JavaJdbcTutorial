...
<body>
    ...
    <div class="md-modal5 md-effect-7" id="modal-3options">
        <div class="md-content">
            ...
            action="InsertBill?username=${infoadmin.username }&password=${infoadmin.password }" 
            method="post">
                <fieldset>
                        <div>
            ...
            <table id="class-info" class="table table-hover text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>${list.maKH }</td>
                        <td>${list.maNV }</td>
                        <td><a href="Display_EditBill?soHD=${list.soHD}&username=${infoadmin.username }&password=${infoadmin.password }">
							<i class="material-icons button edit md-trigger">edit</i> </a>
							<a href="DeleteHoaDon?soHD=${list.soHD}&username=${infoadmin.username }&password=${infoadmin.password }">
            ...
            <nav aria-label="Page navigation example">
                ...
                <!-- numberpage trong HomeController -->
					<c:if test="${numberpage==1}">
	                    ...
	                    <li class="page-item"><a class="page-link" href="DisplayHoaDon?pageid=1&username=${infoadmin.username }&password=${infoadmin.password }">1</a></li>
	                    <li class="page-item"><a class="page-link" href="DisplayHoaDon?pageid=2&username=${infoadmin.username }&password=${infoadmin.password }">2</a></li>
	                    <li class="page-item"><a class="page-link" href="DisplayHoaDon?pageid=3&username=${infoadmin.username }&password=${infoadmin.password }">3</a></li>
	                    <li class="page-item">
	                        <a class="page-link" href="DisplayHoaDon?pageid=${numberpage+1}&username=${infoadmin.username }&password=${infoadmin.password }">Sau</a>
	                    </li>
                    </c:if>
                    
                    <c:if test="${numberpage==maxpageid}">
						<li class="page-item">
	                        <a class="page-link" href="DisplayHoaDon?pageid=${numberpage-1}&username=${infoadmin.username }&password=${infoadmin.password }" tabindex="-1">Trước</a>
	                    </li>
	                    <li class="page-item"><a class="page-link" href="DisplayHoaDon?pageid=1&username=${infoadmin.username }&password=${infoadmin.password }">1</a></li>
	                    <li class="page-item"><a class="page-link" href="DisplayHoaDon?pageid=2&username=${infoadmin.username }&password=${infoadmin.password }">2</a></li>
	                    <li class="page-item"><a class="page-link" href="DisplayHoaDon?pageid=3&username=${infoadmin.username }&password=${infoadmin.password }">3</a></li>
