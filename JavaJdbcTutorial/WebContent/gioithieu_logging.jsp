                        ...
                        <div class="cart_box" style="border-bottom: 1px solid #afa7a7;padding: 10px;height: 120px;">
                            <div class="message">
                                ...
                                <div class="list_desc">
                                        ...
                                        <a href="SaveIntoCart?page=4&username=${infoadmin.username }&password=${infoadmin.password }&command=remove&mamypham=<%=list.getValue().getProduct().getMaMyPham()%>"><span style="font-size:19px;" aria-hidden="true">
    ...
    <div id="about" class="container marketing">
       <!--   -->
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading" style="padding: 50px 0">Giới Thiệu Về THE MEN SHOP</h2>
                <p class="lead">THE MEN SHOP cửa hàng mỹ phẩm dành riêng cho phái mạnh , là nơi phân phối các loại mỹ phẩm uy tín, chất lượng hàng đầu trong và ngoài nước.</p>
                <p class="lead">Hãy đến với chúng tôi, cửa hàng THE MEN SHOP sẽ giúp bạn chăm sóc sắc đẹp bằng mỹ phẩm chất lượng cao, ngoại nhập với dịch vụ hoàn hảo: giao hàng tận nơi , tư vấn nhiệt tình, đảm bảo bạn sẽ hài lòng. Hãy tin tưởng THE MEN SHOP.</p>
                <p class="lead">THE MEN SHOP, vẻ đẹp đích thực sẽ mang đến hạnh phúc đích thực!</p>
            </div>
            <div class="col-md-5">
                <img class="featurette-image img-fluid mx-auto" style="width: 500px; height: 500px;" src="Style/icon/namm.jpg" data-holder-rendered="true">
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7 order-md-2">
                <h2 class="featurette-heading" style="padding: 50px 0">Hợp Đồng Và Kí Kết</h2>
                <p class="lead">Trong từng sản phẩm của THE MEN SHOP, chúng tôi đều khắt khe tính an toàn của từng thành phần và yếu tố cân bằng để tạo nên những sản phẩm Thương hiệu uy tín và chất lượng nhất.  </p>
                <p class="lead">Bởi với chúng tôi, sự an toàn chính là yếu tố quyết định tạo nên một cơ thể khỏe mạnh, từ đó mang đến một vẻ đẹp hoàn hảo.</p>
                <p class="lead">Ngoài ra, THE MEN SHOP còn là đối tác của nhiều thương hiệu mỹ phẩm lớn như: Olay, Neutrogen, Shiseido, The Face Shop,Innisfree...</p>
            </div>
            <div class="col-md-5 order-md-1">
                <img class="featurette-image img-fluid mx-auto" style="width: 500px; height: 500px;" src="Style/icon/Kiket.jpg" data-holder-rendered="true">
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading" style="padding: 50px 0">Người Sáng Lập THE MEN SHOP</h2>
                <p class="lead">LÂM QUANG LỊCH và KA’ HUỪS  TAM BOU là hai tư vấn viên mỹ phẩm và làm đẹp giàu kinh nghiệm của THE MEN SHOP. Chúng tôi bắt đầu kinh doanh mỹ phẩm từ năm 2017. Tận dụng Internet với mô hình kinh doanh trực tuyến cho THE MEN SHOP, chúng tôi đã trở thành những người tiên phong đầu tiên với sự tư vấn nhiệt tình và chăm sóc khách hàng tận tình mọi lúc, mọi nơi.</p>
            </div>
            <div class="col-md-5">
                <img class="featurette-image img-fluid mx-auto" style="width: 500px; height: 500px;" src="Style/icon/de3.jpg" data-holder-rendered="true">
            </div>
        </div>
    </div>
            ...
            <div id="mc_embed_signup">
                ...
                -->
                        <div class="mc-field-group">
                            <input class="input required email" id="content_send" type="email" value="" name="" placeholder="Nhập địa chỉ email của bạn"><input class="button send_follow" id="mc-embedded-subscribe" type="button" value="Gửi" name="subscribe">
                        </div>
                    </div>
                </form>
            </div>
