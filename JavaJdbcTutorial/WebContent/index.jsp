    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="padding: 0 10px">
		...
		<div class="collapse navbar-collapse lead" id="navbar">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<a class="md-trigger nav-link" data-modal="modal-20" id="btn_left3">ĐĂNG NHẬP</a>
				</li>
				<li class="nav-item">
    ...
    <div class="row" style="text-align: center;width: 94%;">
    	<c:forEach var="listsrm" items="${srm }">
          <div class="col-xs-6 col-md-3 hiengiohang">
            ...
            <a href="SaveIntoCart?page=1&command=plus&mamypham=${listsrm.maMyPham }"><h5 id="ThemVaoCart">
        ...
        <c:forEach var="listkd" items="${kemduong }">
          <div class="col-xs-6 col-md-3 hiengiohang">
            ...
            <a href="SaveIntoCart?page=1&command=plus&mamypham=${listkd.maMyPham }"><h5 id="ThemVaoCart">
              <i class="fa fa-shopping-cart" aria-hidden="true"></i> Thêm vào giỏ hàng</h5>
            </a>
   ...
   <hr style="width: 94%;">
    <div class="row" style="text-align: center;width: 94%;">
          ...
          <div class="col-xs-6 col-md-3 hiengiohang">
            ...
            <a href="SaveIntoCart?page=1&command=plus&mamypham=${listkcn.maMyPham }"><h5 id="ThemVaoCart">
              <i class="fa fa-shopping-cart" aria-hidden="true"></i> Thêm vào giỏ hàng</h5>
            </a>
        ...
        <c:forEach var="listst" items="${suatam }">
          <div class="col-xs-6 col-md-3 hiengiohang">
            ...
            <a href="SaveIntoCart?page=1&command=plus&mamypham=${listst.maMyPham }"><h5 id="ThemVaoCart">
              <i class="fa fa-shopping-cart" aria-hidden="true"></i> Thêm vào giỏ hàng</h5>
            </a>
   ...
   <hr style="width: 94%;">
    <div class="row" style="text-align: center;width: 94%;">
          <div class="col-xs-6 col-md-4 hiengiohang">
            <a href="Newspaper1.jsp" class="thumbnail">
          ...
          <div class="col-xs-6 col-md-4 hiengiohang">
            <a href="Newspaper2.jsp" class="thumbnail">
          ...
          <div class="col-xs-6 col-md-4 hiengiohang">
            <a href="Newspaper3.jsp" class="thumbnail">
...
#modal-cart #btn .animated:hover{
    color: #fff;
    background: #ff3b00;
}
#modal-cart #btn .animated {
    background: #ff6200;
    border-radius: 5px;
    text-align: center;
    padding: 10px 20px;
