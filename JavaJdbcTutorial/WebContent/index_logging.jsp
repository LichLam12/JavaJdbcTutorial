...
<div class="md-modal md-effect-7 pre-scrollable2" id="modal-cart">
                        ...
                        <div class="cart_box" style="border-bottom: 1px solid #afa7a7;padding: 10px;height: 120px;">
                            <div class="message">
                                ...
                                <div class="list_desc">
                                        ...
                                        <a href="SaveIntoCart?page=1&username=${infoadmin.username }&password=${infoadmin.password }&command=remove&mamypham=<%=list.getValue().getProduct().getMaMyPham()%>"><span style="font-size:19px;" aria-hidden="true">
        ...
        <div class="md-content">
            <h4>
                <span>
                        Đăng Ký
                        <button type="button" class="close" data-dismiss="modal-studentuser2" aria-label="Close" id="closebtn_1">
                              <span aria-hidden="true">&times;</span>
                        </button>
                </span>
            </h4>
        ...
        <div id="right">
           <center>
            ...
            <div id="btn">
                ...
                <a class="md-trigger btn btn_register" style="width:42%;" data-modal="modal-studentuser2" id="btn_left_1">
        ...
        <script type="text/javascript">
            ...
            //nút close của register
                document.getElementById("btn_left_1").onclick = function abc5() {
                        $("#modal-studentuser2").show();
                    };
                document.getElementById("closebtn_1").onclick = function abc6() {
    ...
    <div class="row" style="text-align: center;width: 94%;">
    	<c:forEach var="listsrm" items="${srm }">
          <div class="col-xs-6 col-md-3 hiengiohang">
            <a href="XemMyPham?mamypham=${listsrm.maMyPham }&username=${infoadmin.username }&password=${infoadmin.password }" class="thumbnail">
              <img src="${listsrm.hinhAnhChinh }" alt="..." style="width: 275px;height: 275px;">
            </a>
            <a href="SaveIntoCart?page=1&username=${infoadmin.username }&password=${infoadmin.password }&command=plus&mamypham=${listsrm.maMyPham }"><h5 id="ThemVaoCart">
        ...
        <c:forEach var="listkd" items="${kemduong }">
          <div class="col-xs-6 col-md-3 hiengiohang">
            <a href="XemMyPham?mamypham=${listkd.maMyPham }&username=${infoadmin.username }&password=${infoadmin.password }" class="thumbnail">
              <img src="${listkd.hinhAnhChinh }" alt="..." style="width: 275px;height: 275px;">
            </a>
            <a href="SaveIntoCart?page=1&username=${infoadmin.username }&password=${infoadmin.password }&command=plus&mamypham=${listkd.maMyPham }"><h5 id="ThemVaoCart">
              <i class="fa fa-shopping-cart" aria-hidden="true"></i> Thêm vào giỏ hàng</h5>
            </a>
   ...
   <hr style="width: 94%;">
    <div class="row" style="text-align: center;width: 94%;">
          ...
          <div class="col-xs-6 col-md-3 hiengiohang">
            <a href="XemMyPham?mamypham=${listkcn.maMyPham }&username=${infoadmin.username }&password=${infoadmin.password }" class="thumbnail">
              <img src="${listkcn.hinhAnhChinh }" alt="..." style="width: 275px;height: 275px;">
            </a>
            <a href="SaveIntoCart?page=1&username=${infoadmin.username }&password=${infoadmin.password }&command=plus&mamypham=${listkcn.maMyPham }"><h5 id="ThemVaoCart">
              <i class="fa fa-shopping-cart" aria-hidden="true"></i> Thêm vào giỏ hàng</h5>
            </a>
        ...
        <c:forEach var="listst" items="${suatam }">
          <div class="col-xs-6 col-md-3 hiengiohang">
            <a href="XemMyPham?mamypham=${listst.maMyPham }&username=${infoadmin.username }&password=${infoadmin.password }" class="thumbnail">
              <img src="${listst.hinhAnhChinh }" alt="..." style="width: 275px;height: 275px;">
            </a>
            <a href="SaveIntoCart?page=1&username=${infoadmin.username }&password=${infoadmin.password }&command=plus&mamypham=${listst.maMyPham }"><h5 id="ThemVaoCart">
              <i class="fa fa-shopping-cart" aria-hidden="true"></i> Thêm vào giỏ hàng</h5>
            </a>
