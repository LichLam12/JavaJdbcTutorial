                        ...
                        <div class="cart_box" style="border-bottom: 1px solid #afa7a7;padding: 10px;height: 120px;">
                            <div class="message">
                                ...
                                <div class="list_desc">
                                        ...
                                        <a href="SaveIntoCart?page=2&pageid=${numberpage }&username=${infoadmin.username }&password=${infoadmin.password }&phanloai=${phanloai }&command=remove&mamypham=<%=list.getValue().getProduct().getMaMyPham()%>"><span style="font-size:19px;" aria-hidden="true">
	...
	<ul class="pagination justify-content-end">
		...
		<c:if test="${numberpage==1}">
			...
			<li class="page-item"><a class="page-link"
				href="DisplayInfoMyPham?phanloai=${phanloai }&pageid=1&username=${infoadmin.username }&password=${infoadmin.password }">1</a></li>
			<li class="page-item"><a class="page-link"
				href="DisplayInfoMyPham?phanloai=${phanloai }&pageid=2&username=${infoadmin.username }&password=${infoadmin.password }">2</a></li>
			<li class="page-item"><a class="page-link"
				href="DisplayInfoMyPham?phanloai=${phanloai }&pageid=3&username=${infoadmin.username }&password=${infoadmin.password }">3</a></li>
			<li class="page-item"><a class="page-link"
				href="DisplayInfoMyPham?phanloai=${phanloai }&pageid=4&username=${infoadmin.username }&password=${infoadmin.password }">4</a></li>
			<li class="page-item"><a class="page-link"
				href="DisplayInfoMyPham?phanloai=${phanloai }&pageid=5&username=${infoadmin.username }&password=${infoadmin.password }">5</a></li>
			<li class="page-item"><a class="page-link"
				href="DisplayInfoMyPham?phanloai=${phanloai }&pageid=${numberpage+1}&username=${infoadmin.username }&password=${infoadmin.password }">Sau</a>
			</li>
		</c:if>

		<c:if test="${numberpage==maxpageid}">
			<li class="page-item"><a class="page-link"
				href="DisplayInfoMyPham?phanloai=${phanloai }&pageid=${numberpage-1}&username=${infoadmin.username }&password=${infoadmin.password }"
				tabindex="-1">Trước</a></li>
			<li class="page-item"><a class="page-link"
				href="DisplayInfoMyPham?phanloai=${phanloai }&pageid=1&username=${infoadmin.username }&password=${infoadmin.password }">1</a></li>
			<li class="page-item"><a class="page-link"
	...
	<div class="row" style="text-align: center;width: 94%;">
		...
		<c:forEach var="list" items="${mypham }">
	          <div class="col-xs-6 col-md-3 hiengiohang">
	            <a href="XemMyPham?mamypham=${list.maMyPham }&username=${infoadmin.username }&password=${infoadmin.password }" class="thumbnail">
	              <img src="${list.hinhAnhChinh }" alt="..." style="width: 275px;height: 275px;">
	            </a>
	            <a href="SaveIntoCart?page=2&pageid=${numberpage }&username=${infoadmin.username }&password=${infoadmin.password }&command=plus&mamypham=${list.maMyPham }&phanloai=${phanloai }">
	            	<h5 id="ThemVaoCart">
