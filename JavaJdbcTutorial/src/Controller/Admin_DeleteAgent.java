...
@WebServlet("/Admin_DeleteAgent")
public class Admin_DeleteAgent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public Admin_DeleteAgent() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String usernamenv=request.getParameter("usernamenv");
		boolean kt = NhanVienDAO.DeleteNhanVien(manv,usernamenv, conn);

		if (kt == true) {
			System.out.println("delete nv thành công");
		}
