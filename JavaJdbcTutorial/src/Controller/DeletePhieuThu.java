...
@WebServlet("/DeletePhieuThu")
public class DeletePhieuThu extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public DeletePhieuThu() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean kt = PhieuThuDAO.DeletePhieuThu(maPhieuThu, conn);

		if (kt == true) {
			System.out.println("delete PT thành công");
		}
