...
@WebServlet("/DisplayHoaDon_NV")
public class DisplayHoaDon_NV extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	String pageidstr;

    public DisplayHoaDon_NV() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("NVXuLyDH_billm.jsp");
