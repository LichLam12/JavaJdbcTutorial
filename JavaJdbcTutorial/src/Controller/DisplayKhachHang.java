...
@WebServlet("/DisplayKhachHang")
public class DisplayKhachHang extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String pageidstr="1";
    public DisplayKhachHang() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<KhachHang> list = KhachHangDAO.DisplayKhachHang(pageid, count, conn);
		
		int sumrow=KhachHangDAO.CountRow(conn);
		...
		request.setAttribute("qlkhachhang", list);
		
		RequestDispatcher rd= request.getRequestDispatcher("admin_clientm.jsp");
