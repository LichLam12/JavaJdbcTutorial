...
@WebServlet("/Display_EditBill")
public class Display_EditBill extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public Display_EditBill() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd= request.getRequestDispatcher("EditHoaDon.jsp");
