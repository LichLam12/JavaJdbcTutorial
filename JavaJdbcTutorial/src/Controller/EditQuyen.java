...
@WebServlet("/EditQuyen")
public class EditQuyen extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		boolean kt = QuyenDAO.UpdateQuyen(maQuyen, tenQuyen, conn);

		if (kt == true) {
			System.out.println("update quyen thành công");
		}
