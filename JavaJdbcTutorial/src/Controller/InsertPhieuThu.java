...
@WebServlet("/InsertPhieuThu")
public class InsertPhieuThu extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public InsertPhieuThu() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			boolean kt = PhieuThuDAO.InsertPhieuThu(sqlDate, soTien, nguoiNop, soHD,conn);
			
			if(kt==true) {
				System.out.println("insert phieu thu thành công");
			}
