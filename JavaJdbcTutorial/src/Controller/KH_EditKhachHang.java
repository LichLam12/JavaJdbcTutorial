...
@WebServlet("/KH_EditKhachHang")
public class KH_EditKhachHang extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
 
    public KH_EditKhachHang() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			boolean kt = KhachHangDAO.UpdateKhachHang(maKH, Username, Password, tenKH, gioiTinh,
					sqlDate, soDT, Email, diaChi, conn);
			
			if(kt==true) {
				System.out.println("KH sua info KH thành công");
			}
